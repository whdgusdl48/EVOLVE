...
event_bins = [5]
image_path = "/mnt/hdddate/bjh/LLE_DAVIS_upX/trainval_480p/Lowlight_Images"
for event_bin in event_bins:

    event_path = "/mnt/hdddate/bjh/LLE_DAVIS_upX/trainval_480p/Lowlight_events"
    target_event_path = "/mnt/hdddate/bjh/LLE_DAVIS_upX/trainval_480p/EventVoxel_" + str(event_bin)
    target_eventvis_path = "/mnt/hdddate/bjh/LLE_DAVIS_upX/trainval_480p/EventVoxelImage_" + str(event_bin)
